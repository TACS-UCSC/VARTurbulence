...
import dataloaders
reload(dataloaders)
from dataloaders import load_turbulence_data_mat, load_turbulence_data_rb_convection, create_turbulence_dataloader
...
def parse_args():
    ...
    parser.add_argument("--start_idx", type=int, default=0, help="Start index for data files")
...
def main():
    ...
    data = load_turbulence_data_rb_convection(
        args.data_loc,
